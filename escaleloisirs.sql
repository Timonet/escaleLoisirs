...
--
-- Client :  localhost
-- Généré le :  Jeu 29 Mars 2018 à 12:03
...
CREATE TABLE `activites` (
  ...
  `heure_fin_activite` time NOT NULL,
  `code_personne_activite` int(11) NOT NULL,
  `code_categorie_activite` int(11) NOT NULL
...
CREATE TABLE `inscriptions` (
  ...
  `code_personne_inscription` int(11) NOT NULL,
  `code_activite_inscription` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `personnes` (
  ...
  `telephone_personne` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `code_role_personne` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `activites`
  ...
  ADD KEY `FK_activites_code_personne` (`code_personne_activite`),
  ADD KEY `FK_activites_code_categorie` (`code_categorie_activite`);
...
ALTER TABLE `inscriptions`
  ADD PRIMARY KEY (`code_personne_inscription`,`code_activite_inscription`),
  ADD KEY `FK_inscrit_code_activite` (`code_activite_inscription`);
...
ALTER TABLE `personnes`
  ...
  ADD KEY `FK_personnes_code_role` (`code_role_personne`);
...
--
ALTER TABLE `activites`
  MODIFY `code_activite` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `personnes`
  MODIFY `code_personne` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
--
...
--
ALTER TABLE `activites`
  ADD CONSTRAINT `FK_activites_code_categorie` FOREIGN KEY (`code_categorie_activite`) REFERENCES `categories` (`code_categorie`),
  ADD CONSTRAINT `FK_activites_code_personne` FOREIGN KEY (`code_personne_activite`) REFERENCES `personnes` (`code_personne`);

--
-- Contraintes pour la table `inscriptions`
--
ALTER TABLE `inscriptions`
  ADD CONSTRAINT `FK_inscrit_code_activite` FOREIGN KEY (`code_activite_inscription`) REFERENCES `activites` (`code_activite`),
  ADD CONSTRAINT `FK_inscrit_code_personne` FOREIGN KEY (`code_personne_inscription`) REFERENCES `personnes` (`code_personne`);

--
-- Contraintes pour la table `personnes`
--
ALTER TABLE `personnes`
  ADD CONSTRAINT `FK_personnes_code_role` FOREIGN KEY (`code_role_personne`) REFERENCES `roles` (`code_role`);
